...
//  * @param {*} code should be either 'line-item/day' or 'line-item/night'
//  */
// const getDateRangeQuantityAndLineItems = (orderData, code, unitPrice) => {
//   // bookingStart & bookingend are used with day-based bookings (how many days / nights)
//   // const { bookingStart, bookingEnd } = orderData || {};
//   // const quantity =
//   //   bookingStart && bookingEnd ? calculateQuantityFromDates(bookingStart, bookingEnd, code) : null;
...
//     Math.floor(unitPrice.amount * (1 - discount)),
//     unitPrice.currency
//   );

//   return { quantity, unitPrice: discountedPrice, extraLineItems: [] };
// };
...
//       ? getHourQuantityAndLineItems(orderData)
//       : ['day', 'night'].includes(unitType)
//       ? getDateRangeQuantityAndLineItems(orderData, code, unitPrice)
//       : {};

//   // const { quantity, extraLineItems } = quantityAndExtraLineItems;
//   const { quantity, unitPrice: discountedPrice, extraLineItems } = 
//     ['day', 'night'].includes(unitType)
//     ? getDateRangeQuantityAndLineItems(orderData, code)
//     : {};
...
//   const order = {
//     code,
//     unitPrice: discountedPrice,  // CHANGED: Use the discounted price
//     quantity,
//     includeFor: ['customer', 'provider'],
//   };
