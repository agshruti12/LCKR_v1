...
const DISCOUNT_CODE = 'line-item/discount';
...
exports.transactionLineItems = (listing, orderData, providerCommission) => {
  ...
  // Determining the discount value based on quantity
  const discountValue = quantity > 5 ? new Money(-1000, currency) : new Money(0, currency);
  ...
  const lineItems = [order, ...extraLineItems, discountLineItem, ...providerCommissionMaybe];
